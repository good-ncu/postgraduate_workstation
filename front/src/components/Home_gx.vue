      ...
      <el-aside :width="isCollapase?'64px':'230px'">
        ...
        <el-menu
          ...
          <el-submenu index="100" key="100" >
            ...
            <el-menu-item index="/userManager" key="101" @click="saveNavState('/userManager')">
              <template slot="title">
                <i :class="iconsObject[101]" style="font-size: 20px"></i>&nbsp;
                <span style="font-size: 20px">报备账号管理</span>
              </template>
            </el-menu-item>

            <el-menu-item index="/gxSH" key="102" @click="saveNavState('/gxSH')">
              <template slot="title">
                <i :class="iconsObject[102]" style="font-size: 20px"></i>&nbsp;
                <span style="font-size: 20px">报备单位审核</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/applySearch" key="103" @click="saveNavState('/applySearch')">
              <template slot="title">
                <i :class="iconsObject[103]" style="font-size: 20px"></i>&nbsp;
                <span style="font-size: 20px">历年报备查询</span>
              </template>
            </el-menu-item>
          </el-submenu>
          <el-submenu index="200" key="200">
            ...
            <!--二级菜单-->
            <!--<el-menu-item :index="it.submenu_path" v-for="it in item.mainmenu_sList" :key="it.submenu_id" @click="saveNavState(it.submenu_path)">-->
<!--            <el-menu-item index="/gxInfo" key="201" @click="saveNavState('/gxInfo')">-->
<!--              <template slot="title">-->
<!--                <i :class="iconsObject[201]" style="font-size: 20px"></i>&nbsp;-->
<!--                <span style="font-size: 20px">用户信息设置</span>-->
<!--              </template>-->
<!--            </el-menu-item>-->
            <el-menu-item index="/gxPasswd" key="202" @click="saveNavState('/gxPasswd')">
              <template slot="title">
...
export default {
  ...
  data() {
    return {
      ...
      iconsObject:{
        '100':'iconfont icon-zhuantimulu',
        '200':'iconfont icon-xitongshezhi',
        '101':'iconfont icon-yuanshuju-xiugairen',
        '102':'iconfont icon-AI-xitongguanli',
        '103':'iconfont icon-a-ziyuan58',
        '201':'iconfont icon-yuanshuju-yemianguanli',
        '202':'iconfont icon-bianji'
      },
      activePath:''
    }
  },
